...
const TRANSLATIONS = {
  en: {
    ...
    about_p1:"Hi, I'm KaaOffc Dev — a passionate frontend developer who loves crafting beautiful, responsive, and high-performance web interfaces. I specialize in turning complex ideas into stunning digital realities.",
    ...
    p2_title:'KaaOffc Lobby Generator', p2_desc:'Free Fire lobby generator with HD image export, custom nickname styling, and MLBB support. Features real-time preview.',
    ...
    p4_title:'KaaOffc IQC Generator', p4_desc:'iPhone Quote Card generator with customizable templates, font styling, and instant download. Features server health monitoring.',
    contact_tag:'Contact',
  ...
  id: {
    ...
    about_p1:'Halo, saya KaaOffc Dev — seorang frontend developer yang bersemangat dalam membangun antarmuka web yang indah, responsif, dan berperforma tinggi. Saya mengkhususkan diri dalam mengubah ide kompleks menjadi realitas digital yang memukau.',
    ...
    p2_title:'Generator Lobby KaaOffc', p2_desc:'Generator lobby Free Fire dengan ekspor gambar HD, styling nickname kustom, dan dukungan MLBB. Fitur pratinjau real-time.',
    ...
    p4_title:'Generator IQC KaaOffc', p4_desc:'Generator Quote Card iPhone dengan template yang dapat dikustomisasi, styling font, dan unduh instan. Fitur pemantauan kesehatan server.',
    contact_tag:'Kontak',
...
/* ─── Easter egg ─────────────────────────── */
console.log('%c⚡ KaaOffc DEV','color:#7DF9C8;font-size:2rem;font-weight:bold;font-family:monospace;');
